...
<body>
	...
	<div id="carouselContainer">
		...
		<div id="newestGame" class="carousel slide" data-ride="carousel">
			...
			<div class="title-container" id="newestGameContainer">
				<h1 class="carousel-title">NUOVI ARRIVI</h1>
			</div>
			...
			</a> <a class="carousel-control-next" href="#newestGame"
		...
		<div id="lowestPrice" class="carousel slide" data-ride="carousel">
			...
			<div class="title-container" id="lowestPriceContainer">
				<h1 class="carousel-title">I PREZZI PIU' BASSI</h1>
			</div>
			<div class="carousel-inner">
				<%
			...
			<a class="carousel-control-prev" href="#lowestPrice"
				data-slide="prev"> <span class="carousel-control-prev-icon"></span>
			</a> <a class="carousel-control-next" href="#lowestPrice"
				data-slide="next"> <span class="carousel-control-next-icon"></span>
			</a>
		</div>
	</div>
	...
	<div class="header" id="gameSearchBarContainer">
		<nav
			class="navbar navbar-expand-lg navbar-expand-sm navbar-expand-md  navbar-dark bg-dark"
			name="barraNavigazione" id="barraNavigazione">


			<div class="navbar-nav mr-auto col-lg-4 col-md-4 col-sm-6">
				<p class="nav-item"
					style="vertical-align: middle; margin: auto; color: #ced4da;">
					CATALOGO PRODOTTI</p>
	...
	<div class="container main-section" id="productContainer">
		<div class="row">
			...
			%>
			<div
				class="col xl-auto col-lg-auto col-md-auto col-sm-auto col-xs-auto">
				<div class="product-card">
					<div class=" product-front">
						<div class="shadow"></div>
						<img src="<%=image.getName()%>" alt="" width="335px"
							height="200px" />
						...
						%>
						<div>
							<a class="addToCart disabled">NON DISPONIBILE</a>
						</div>
						<%
							}
						%>
						<div class="stats">
							<div class="stats-container">
								...
								<div class="product-options">
									<div class="row">
										<div class="col">
											<strong>GENERE</strong> <span><%=game.getGenere()%></span> <strong>PIATTAFORMA</strong>
											<div class="piattaforma">
												<div>
													<span><img
														src="img/website/platform/<%=game.getPiattaforma()%>.png"
														width="50px" height="50px"></span>
												</div>
											</div>
										</div>
										<div class="col">
											<strong>ANNO</strong> <span><%=game.getAnno()%></span> <strong>PEGI</strong>
											<div>
												<span><img
													src="img/website/PEGI/<%=game.getPegi()%>.png" width="50px"
													height="50px"
													onerror="this.style.display='img/website/error.png'" /></span>
											</div>
										</div>
									</div>
								</div>
