...
<body>
 ...
 <%if(composizioneOrdini!= null && composizioneOrdini.size()!=0){ %> 
	 ...
	 <div class="intestazione">
		...
		<hr></hr>
	    <form class="form-inline my-2 my-lg-0" action="order?action=cercaOrdini" method="post" >
  ...
  while(it1.hasNext()){
    ...
    <tr>
      ...
      <%if (trovato==true && quantity!=0) {%>
       <td style=" display: block;"><a href="product?action=carrello" id="<%=comp.getGioco()%>" class="btn btn-warning addCart " >
